...
interface DistrictRepository: JpaRepository<District, Int> {
    ...
    @Query(
            "SELECT " +
            "NEW com.chillibits.coronaaid.model.dto.DistrictAnalyticsDto(dis.name, dis.city, 0.0+ST_Area(dis.geometry), dis.postalCode, COUNT(inf), dis.geometry) " +
            ...
            "GROUP BY dis.id")
    fun getAnalyzedDistrictData() : List<DistrictAnalyticsDto>
